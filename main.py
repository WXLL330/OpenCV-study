...
Path = "picture_source/circle.jpg"
Save_Path = "picture_result/"
Reduced_ratio = 4
Guassian_kernal_size = 3
HT_high_threshold = 45
HT_low_threshold = 25
Hough_transform_step = 7
Hough_transform_threshold = 40
...
if __name__ == '__main__':
    ...
    cv2.imwrite(Save_Path + "MYcanny_circle2.jpg", canny.img)
    ...
    cv2.imwrite(Save_Path + "MYhough_circle2.jpg", img_RGB)
    print ('Finished!')
